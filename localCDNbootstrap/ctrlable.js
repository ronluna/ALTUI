...
Localization.init( {
  ...
  "Welcome to ALTUI":"Welcome to Ctrlable"
});

Localization.setTitle("Ctrlable WebUI");
Localization.setBrandingCallback( function() {
	$("#altui-theme-selector").remove();
        $("#altui-credits").remove();
        $("#altui-evolutions").remove();
        $("#altui-license-page").remove();
...
$("body").append("<div id='mobilelogo'></div>");
$("#mobilelogo").addClass("mobilelogo1");
